...
namespace CreativeTechnologies
{
    public class StringCalculatorTests
    {
        ...
        {
            var calculatedResult = stringCalculator.Add(numbers);
        ...
        [TestCase("1,10001", ExpectedResult = 1)]
        [TestCase("1\n10010", ExpectedResult = 1)]
        [TestCase("//$\n1,1201", ExpectedResult = 1)]
        [TestCase("//$\n1$1301", ExpectedResult = 1)]
        [TestCase("//$\n1$2,1101", ExpectedResult = 3)]
